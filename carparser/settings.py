...
USER_AGENT = 'Mozilla/5.0 (Linux; Android 7.0; SM-G892A Build/NRD90M; wv) AppleWebKit/537.36 (KHTML, like Gecko) ' \
...
DEFAULT_REQUEST_HEADERS = {
    ...
    # 'Referer': 'https://m.avito.ru/tyumen/avtomobili?cd=1&radius=200',
    'Host': 'm.avito.ru',
    'DNT': '1',
}
